    ...
    while True:
        ...
        if(len(ball_postition_history) > 1):
           ...
           # inp_temp=np.array([scene_info.ball[0],scene_info.ball[1],scene_info.platform_1P[0],vx,vy])
            #inp_temp=np.array([scene_info.ball[0],scene_info.ball[1],scene_info.platform_1P[0],vx,vy])
            inp_temp=np.array([scene_info.ball[0],scene_info.ball[1],scene_info.platform_2P[0],(200-scene_info.ball[0]),(scene_info.ball[0]-scene_info.platform_2P[0]),(scene_info.ball[1]-80),vx,vy,scene_info.ball_speed])
